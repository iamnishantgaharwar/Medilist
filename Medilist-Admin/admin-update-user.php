...
<?php
		if (isset($_GET['edit'])){
			$edit = $_GET['edit'];
			$update = "SELECT *FROM `customer` WHERE cus_id='$edit'";
			$rec= mysqli_query($con,$update);
			$record= mysqli_fetch_assoc($rec);
			$cus_name=$record['cus_name'];
			$cus_contact=$record['cus_contact'];
			$cus_email =$record['cus_email'];
...
<form class="" action="admin-user-process.php" method="post">
		...
		<input class="form-control" type="text" name="cus_name" value="<?php echo $cus_name; ?>" placeholder="Name"><br>
		<input class="form-control" type="text" name="cus_contact" value="<?php echo $cus_contact; ?>" placeholder="Contact"><br>
		<input class="form-control" type="email" name="cus_email" value="<?php echo $cus_email; ?>" placeholder="Email"><br>
		<input class="form-control" type="text" name="cus_address" value="<?php echo $cus_address; ?>" placeholder="Address"><br>
